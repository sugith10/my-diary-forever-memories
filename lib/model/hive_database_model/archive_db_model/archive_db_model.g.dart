...
part of 'archive_db_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ArchiveDiaryAdapter extends TypeAdapter<ArchiveDiary> {
  @override
  final int typeId = 5;

  @override
  ArchiveDiary read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ArchiveDiary obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.id)
